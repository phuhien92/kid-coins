...
import type { AppNavItem } from "@/components/shared/AppNav/types";

export type ParentNavSection = "home" | "approvals" | "kids" | "settings";

export type ParentNavItem = AppNavItem & { id: ParentNavSection };
...
/** Placeholder until parent session / family context is wired. */
export const PARENT_SHELL_PLACEHOLDER = {
  name: "Sam",
  fullName: "Sam Rivera",
  family: "The Rivera family",
  avatarColor: "var(--color-lav)",
  kidCount: 2,
  goalCount: 3,
} as const;
